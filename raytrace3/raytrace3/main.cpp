...
public:
	...
	void init(int h_ = 500, int w_ = 500, int fovAng = 45, const Vec3 &pos_ = Vec3(25, 58, 210.6), const Vec3&dir_ = Vec3(0, -0.122612, -1)) {
#ifdef DEBUG
...
public:
	Vec3 P0;//平面上一点
	Vec3 n;//单位法向量
	PlaneObj(const Vec3& pp, const Vec3 &nn, const Material & mm, const Color &cc = Color(1, 1, 1)) :P0(pp), n(nn), Obj(mm, cc) {}
